    ...
    <>
        {isLoading ?
            <button
                disabled
                type={type}
                className="text-white focus:ring-orange-300 focus:outline-none font-bold rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800 inline-flex items-center">
